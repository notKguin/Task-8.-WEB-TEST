...
ROOT_URLCONF = "volunteer_service.urls"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "volunteer_db"),
        "USER": os.getenv("POSTGRES_USER", "volunteer_user"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "volunteer_pass"),
